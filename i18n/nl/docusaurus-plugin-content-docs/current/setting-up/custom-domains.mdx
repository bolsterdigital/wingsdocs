...
Als je alleen een subdomein van een bestaand domein wilt gebruiken voor je Wings-project - bijvoorbeeld: `action.mywebsite.com`, maak dan een CNAME-record aan voor je subdomein en verwijs het naar `cname.vercel-dns.com.`.
...
- maak een A-record voor jouw domein (zonder www) en wijs het naar `76.76.21.21`
- maak een CNAME-record aan voor `www.uwdomein.com` (waarschijnlijk hoef je alleen het `www`-deel in te vullen) en verwijs het naar `cname.vercel-dns.com.`.
