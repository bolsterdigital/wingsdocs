...
In den Übersetzungseinstellungen Ihrer App können Sie die von Ihnen erstellte Übersetzung auswählen (weitere Informationen finden Sie auf der separaten [Mehrsprachigkeit-Seite](/de/docs/setting-up/use-multiple-languages).
...
Weitere Informationen finden Sie auf der separaten Seite [Sprachen](/de/docs/setting-up/use-multiple-languages).
...
Siehe [hier](/de/docs/guides/webhooks) für eine separate Dokumentationsseite zu Webhooks.
