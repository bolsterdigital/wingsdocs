...
Wenn Sie für Ihr Wings-Projekt nur eine Subdomain einer bestehenden Domain verwenden möchten - zum Beispiel: `aktion.meinewebsite.de`, erstellen Sie einen CNAME-Record für Ihre Subdomain und verweisen Sie ihn auf `cname.vercel-dns.com.`.
...
- Erstellen Sie einen A-Eintrag für Ihre Domain (ohne www) und verweisen Sie ihn auf `76.76.21.21`
- Erstellen Sie einen CNAME-Eintrag für `www.yourdomain.com` (du musst wahrscheinlich nur den 'www'-Teil ausfüllen) und verweisen Sie ihn auf `cname.vercel-dns.com.`.
