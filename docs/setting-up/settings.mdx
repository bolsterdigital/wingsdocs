...
On the the Translations settings of your App, you can select the Translation you have created (see the separate [Languages page](/docs/setting-up/use-multiple-languages) for more information).
...
See the separate [Languages](/docs/setting-up/use-multiple-languages) page for more information.
...
See [here](/docs/guides/webhooks) for a separate documentation page about Webhooks.
